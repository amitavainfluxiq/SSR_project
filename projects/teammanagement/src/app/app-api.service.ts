...
export class ApiService {
  ...
  public accesstoken:any='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmb28iOiJiYXIiLCJleHAiOjE1Njk2NTAyMTMsImlhdCI6MTU2OTU2MzgxM30.mVWWbPb_MjemAGic0dODbGOoqxI2G7sXqwIgfR5QOQ0';
  fileservername: any = [];
